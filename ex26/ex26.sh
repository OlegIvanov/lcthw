...
# get the source to base APR 1.4.8
curl -L -O http://archive.apache.org/dist/apr/apr-1.4.8.tar.gz
...
# reset and cleanup
cd /tmp
rm -rf apr-1.4.8 apr-1.4.8.tar.gz
...
#cleanup
cd /tmp
rm -rf apr-util-1.5.2* apr-1.5.2*
